...
var Calendar = React.createClass({displayName: "Calendar",
  ...
  render: function() {
    ...
    var selectedDate = this.props.selectedDate?
      this.props.selectedDate.clone().startOf('day') : null;
    return (
        ...
        React.createElement("div", {className: "clndr-grid"}, 
          React.createElement("div", {className: "day-headers"}, 
            this.props.showDaysOfWeek && this.daysOfWeek().map(function(day, i)  {
              return React.createElement("div", {key: 'weekday-' + i, className: "day-header"}, React.createElement("div", {className: "day-content"}, day));
            })
          ), 
          React.createElement("div", {className: "days"}, 
            this.days().map(function(day, i)  {
              ...
              if(day.day.isSame(now, 'day')){
                day.day.classes.push('today');
              }

              if(selectedDate && day.day.isSame(selectedDate, 'day')){
